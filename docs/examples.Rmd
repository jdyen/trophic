...
The `trophic` package has several different uses. These are some examples of possible use cases. Please feel free to contribute your own additions (see [here](docs/contribute.html) for details).
