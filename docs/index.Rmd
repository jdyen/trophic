...
## more information
The [examples](docs/examples.html) has a set of example `trophic` analyses. If you'd like to contribute, check out the [contributions](docs/contribute.html) page. 
